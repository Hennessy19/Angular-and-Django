...
def departmentApi(request,id=None):
    ...
    if request.method=='GET':  #I cannot get a particular record
        if id:
        ...
        return JsonResponse("Failed to Update.", safe=False) #safe=False is used to allow any data type to be returned
